...
description: A quantum theory of light explaining why electrons are ejected from metals only above a threshold frequency, earning the 1921 Nobel Prize in Physics.
importance: 4
category: physics
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        <img loading="eager" src="/assets/img/8.jpg" title="Photoelectric effect" class="img-fluid rounded z-depth-1" alt="Photoelectric effect apparatus" />
    </div>
    <div class="col-sm mt-3 mt-md-0">
        <img loading="eager" src="/assets/img/3.jpg" title="Wave-particle duality" class="img-fluid rounded z-depth-1" alt="Wave-particle duality visualization" />
    </div>
    <div class="col-sm mt-3 mt-md-0">
        <img loading="eager" src="/assets/img/5.jpg" title="Photovoltaic cells" class="img-fluid rounded z-depth-1" alt="Modern photovoltaic applications" />
    </div>
</div>
<div class="caption">
    From the photoelectric apparatus to wave-particle duality and modern photovoltaic applications — the lasting legacy of the 1905 quantum hypothesis.
</div>
