---
title: Bose-Einstein Condensate Theory
description: A quantum statistical theory predicting that bosons at sufficiently low temperatures will occupy the same ground state, forming a new phase of matter with macroscopic quantum coherence.
importance: 5
category: physics
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        <img loading="eager" src="/assets/img/9.jpg" title="BEC visualization" class="img-fluid rounded z-depth-1" alt="Bose-Einstein condensate" />
    </div>
    <div class="col-sm mt-3 mt-md-0">
        <img loading="eager" src="/assets/img/7.jpg" title="Quantum gas experiment" class="img-fluid rounded z-depth-1" alt="Ultracold quantum gas" />
    </div>
    <div class="col-sm mt-3 mt-md-0">
        <img loading="eager" src="/assets/img/8.jpg" title="Superfluidity" class="img-fluid rounded z-depth-1" alt="Superfluid vortices" />
    </div>
</div>
<div class="caption">
    Experimental and theoretical representations of Bose-Einstein condensation, from ultracold atomic gases to superfluid vortex lattices.
</div>
