...
export const site = {
  ...
  description: 'SeungJong Ha (HaMa) — M.S. student at KAIST School of Computing (CASYS Lab). Systems, operating systems, and Rust.',
  ...
  author: {
    ...
    email: 'seungjong.ha@casys.kaist.ac.kr',
  ...
  og: {
     ...
     *  NOTE: disabled — the Satori OG-card generator can't parse the bundled WOFF font,
     *  and Korean post titles would need a CJK font anyway. Re-enable after bundling a
     *  CJK-capable TTF/OTF in src/pages/og/[...path].png.ts. */
    enabled: false,
